// 파일 위치: src/domains/memo/components/MemoItem.jsx
// 기능 요약: 사이드바 탐색기 내부에 표시되는 개별 메모 카드(아이콘, 제목, 복사/더보기 버튼)를 렌더링하는 UI 컴포넌트

import React from 'react';
import { FileTextIcon, LinkIcon, MoreVerticalIcon } from './MemoIcons';

const MemoItem = ({ m, isActive, setActiveMemoId, handleCopyPath, openMoveMenu }) => {
  return (
    <div
