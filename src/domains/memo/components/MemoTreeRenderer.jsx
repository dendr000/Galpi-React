// 파일 위치: src/domains/memo/components/MemoTreeRenderer.jsx
// 기능 요약: 다중 계층(Depth) 폴더 구조를 재귀 함수 형태로 순회하며 렌더링하고, 폴더별 추가/수정/삭제 액션을 제어하는 컴포넌트

import React from 'react';
import { FolderPlusIcon, EditIcon, XIcon, FolderIcon, LinkIcon } from './MemoIcons';
import MemoItem from './MemoItem';

const MemoTreeRenderer = ({ node, sidebarHooks, currentFolder, setCurrentFolder, handleCopyPath, activeMemoId, setActiveMemoId }) => {
...
export default MemoTreeRenderer;